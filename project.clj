(defproject br "0.1.0-SNAPSHOT"
  ...
  :closp-crud {:jdbc-url "jdbc:sqlite:./db/br.sqlite"
               :migrations-output-path "./resources/migrators/sqlite"
               :clj-src "src/clj"
               :ns-db "de.sveri.br.db"
               :ns-routes "de.sveri.br.routes"
               :ns-layout "de.sveri.br.layout"
  ...
  {:builds {:dev {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                  :figwheel {:css-dirs ["resources/public/css"]             ;; watch and update CSS
                             :on-jsload "br.dev/main  "}
                  :compiler     {:main           "br.dev"
  ...
  :profiles {:dev     {:repl-options {:init-ns          de.sveri.br.user}
                       ...
                       :joplin {:databases {:sqlite-dev {:type :sql, :url "jdbc:sqlite:./db/br.sqlite"}
